    ...
    <div class="d-flex justify-content-center">
        <table>
            <tr>
                ...
                <td style="padding-left: 2rem;">
                    <ul class="list-group list-group-flush">
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="Sebastian">
                    </ul>
                    <br>
                    <ul class="list-group list-group-flush">
                    ...
                    <br>
                    <ul class="list-group list-group-flush">
                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="920205251">
                    </ul>
                </td>
            </tr>
        </table>
