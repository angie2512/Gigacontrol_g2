  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        <li><a href="/AdminInicio.jsp" class="nav-link px-2"><b style="color:#1A3B85"><%=userLog.getNombre().toUpperCase() + " " + userLog.getApellido().toUpperCase()%></b></a></li>
      ...
      <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
        <a class="dropdown-item" href="/ServletInicio?action=logout"><u style="color:#1A3B85"> <b>Cerrar sesión > </b></u></a>
      </form>
      ...
      <div class="card">
        <div class="card-body">
          <table>
            <tbody><tr>
              <div class="col-md-1">
                <td><img src="resources/Images/usu.png" class="rounded mx-auto d-block " alt="userphoto" height="60rem" width="60rem"></td>
              </div>

                <td style="padding-left: 2rem;"><p class="card-text"><b><%=employee.getApellido().toUpperCase() +", "+employee.getNombre()%></b>
                  <b style="color:#B1120D; padding-left: 2rem;"><%=employee.getCodigo()%></b>
                  <b style="color:#C0C4C7; padding-left: 2rem;"><%=employee.getCategoria()%> </b></p></td>

                <td style="padding-left: 2rem;"><a href="<%=request.getContextPath()%>/ServletAdmin?action=Editar&id=<%=employee.getIdUsuario()%>" class="btn btn-primary">Editar</a></td>
