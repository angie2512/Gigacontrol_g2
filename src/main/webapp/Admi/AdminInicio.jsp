    ...
    <div class="abs-center">
        ...
        <center>
            ...
            <div class="abs-center">
                ...
                <form method="post" class="text-center" action="<%=request.getContextPath()%>/PerfilUsuario?action=actualizarFotoPerfiladmi" enctype="multipart/form-data">

                    <label for="file-upload" class="custom-file-upload btn btn-danger" title="Subir Foto" style="background-color: #131950; border-color:#131950">
                        <i class="fa fa-camera"></i>
                    </label>
                    <input id="file-upload" type="file" name="Newphoto"/>

                    <button type="submit" class="btn btn-danger" title="Actualizar", style="background-color: #131950; border-color: #131950">
                ...
                <div class="card" style="background-color:#F2F2F3">
                    <div class="card-body" >
                        <div class="p-1 mb-8 text-white" style="background-color:#131950">
                        ...
                        <blockquote class="blockquote mb-0">
                            ...
                            <h6 style="text-align: center;">Correo: <%=userlogged.getCorreo()%></h6>
                            <h6 style="text-align: center;">Código: <%=userlogged.getCodigo()%></h6>
                            <h6 style="text-align: center;">DNI: <%=userlogged.getDni()%></h6>
                            <h6 style="text-align: center;">Celular: <%=userlogged.getCelular()%></h6>
                        </blockquote>
