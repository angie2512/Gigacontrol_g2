...
<div class="d-flex justify-content-center">
    <center>
        <div class="card" style="width: 48rem; background-color:#00000090">
            ...
            <h6 style="font-family: 'Comic Sans MS', cursive, sans-serif; color:#FFFFFF" class="card-subtitle">Servicio de ayuda a incidencias en la comunidad PUCP</h6>
            <center>
            ...
            <div class="d-grid gap-2 col-8 mx-auto">
                <a href=<%=request.getContextPath()%>/InicioDeSesion style="color: rgb(141, 15, 15);"><button class="btn btn-light" type="button" class="btn btn-secondary" style="color:#686B6E ; width: 15rem; font-size: 15px;"><b>Iniciar Sesión</b></button></a>
                <a href=<%=request.getContextPath()%>/Registro style="color: rgb(141, 15, 15);"><button class="btn btn-light" type="button" style="color:#686B6E; width: 15rem; font-size: 15px;"><b>Registrarse</b></button></a>
                <p></p>
                <p></p>
            </div>
        </div>
