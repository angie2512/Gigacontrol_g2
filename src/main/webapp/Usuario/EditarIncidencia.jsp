    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            ...
            <ul class="nav col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 justify-content-center mb-md-0">
                <li><a class="nav-link px-2"><b style="color:#211426"><%=userlogged.getNombre() + " " + userlogged.getApellido()%></b></a></li>
                ...
                <form action="<%=request.getContextPath()%>/ServletUsuario?action=editarIncidencia" method="post">
                    <div class=" table-responsive">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="inputDescripcion" placeholder="Descripción de la incidencia" value="<%=incidencia.getDescripcion()%>" name="descripcion" aria-describedby="passwordHelpInline">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Se editará su incidencia</h5>
