...
<table>
    ...
    <tr>
        ...
        <td width="1200px" ></td>
        <td><a class="dropdown-item" href="Inicio.html"><u style="color:#1A3B85"> <b> Volver </b></u></a></td>
        </td>
        </td>
        </td>
        </td>
...
<center>
    <div class="card" style="width: 48rem; background-color:#00000090">
        <p></p>
        <p></p>
        <h2 style="font-family: 'KrinkesDecorPERSONAL'; color:#FFFFFF" class="card-title"><b>INICIO DE SESIÓN</b></h2>
        <center>
            <img src="https://pngimage.net/wp-content/uploads/2018/05/cuadrado-azul-png-5.png" alt="linea" width="520" height="6">
        </center>
        <p></p>
        <h5 style="font-family: 'Times New Roman', Times, serif; color:#FFFFFF" class="card-text"><b> Ingrese sus datos </b></h5>
        <p></p>
        ...
        <p></p>
        <p></p>
        <a href="inicioUsuario.html"><button class="d-grid gap-1 col-2 mx-auto btn btn-primary" type="button">Ingresar</button></a>
        <p></p>
    </div>
    </div>
</center>
