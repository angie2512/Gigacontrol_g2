            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<%=request.getContextPath()%>/ServletUsuario?action=registroIncidencia"
                              method="post">
                            <div class=" table-responsive">
                                <div class="input-group mb-3">
                                    <span for="inputName" class="col-lg-2 input-group-text" id="basic-addon1"
                                          style="text-align: center"> Nombre</span>
                                    <input type="text" id="inputName" class="form-control"
                                           placeholder="Nombre de la incidencia" name="nombre"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputDescripcion"
                                           placeholder="Descripción de la incidencia" name="descripcion"
                                           aria-describedby="passwordHelpInline">
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="inputZonaPucp" class="form-control"
                                           placeholder="Zona de la incidencia" name="zonaPucp"
                                           aria-describedby="passwordHelpInline">
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="inputUbica" class="form-control"
                                           placeholder="Ubicacion de la incidencia" name="ubicacion"
                                           aria-describedby="passwordHelpInline">
                                </div>
                                <div class="input-group mb-3">
                                    <label for="tipoIncidencia" class="col-lg-2 input-group-text">
                                ...
                                <div class="input-group mb-3">
                                    <label class="col-lg-2 input-group-text" for="nivelUrgencia">
                                        <center> Nivel de Urgencia</center>
                                    </label>
                                ...
                                <form action="<%=request.getContextPath()%>/ServletUsuario?action=agregarFotoPerfil"
                                      method="post" enctype="multipart/form-data">
                                    <div class="input-group mb-3" style="max-width: 60rem">
                                        <span for="file-upload" class="col-lg-2 input-group-text"><center>Insertar Foto</center></span>
                                        <label class="input-group-text" for="file-upload"><img
                                                src="https://img.icons8.com/metro/26/null/camera.png"/></label>
                                        <input type="file" class="form-control" id="file-upload" name="foto">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Se registrará una
                                                        nueva Incidencia</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <br><a class="btn btn-primary"
                                                               href="<%=request.getContextPath()%>/ServletUsuario?action=nuevaIncidencia"
                                                               role="button"
