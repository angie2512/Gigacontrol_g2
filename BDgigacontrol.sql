CREATE DATABASE  IF NOT EXISTS `gigacontrol` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gigacontrol`;
...
INSERT INTO `comentarincidencia` VALUES (1,26,1,'Ok el equipo de mantenimiento se encargará de repararlo','2022-11-24 22:22:00'),(2,10,1,'Han pasado 4 dias y aun sigue la grieta','2022-11-24 22:30:12'),(3,26,2,'Correcto , se procederá con el reparo para el dia martes','2022-11-24 22:33:17'),(4,6,2,'OK','2022-11-24 22:36:04'),(5,26,3,'De acuerdo , se revisarán las camaras de seguridad para encontrarlos','2022-11-24 22:37:47'),(6,1,3,'Disculpe, llegarón a encontrarlos ?','2022-11-24 22:38:58'),(7,26,4,'El Personal de Salud Irá en Camino','2022-11-24 22:42:46'),(8,2,4,'Ok por favor','2022-11-24 22:43:35'),(9,2,4,'Ya me atendieron , gracias','2022-11-24 22:43:53');
...
INSERT INTO `incidencia` VALUES (1,'Hay una grieta notable','La grieta es de aproximadamente 15 ccm, alrededor existe humedad','ceprepuc','aula 305',NULL,10,3,2,1),(2,'La baranda de la escalera esta floja','Al usar la baranda, esta se sale fácilmente','pabellon Z','piso 2',NULL,6,3,3,3),(3,'Olvide mis audifonos ','Al revisar mi mochila me di cuenta que faltaban mis audifonos y el último lugar en el que estuve fue cia','cia','cubiculo 19',NULL,1,2,1,1),(4,'Me tropecé con la mesa ','Sin fijarme, tropecé y ahora siento hinchado mi dedo del pie','tinkuy','piso 1',NULL,2,4,2,4),(5,'No encuentro mi calculadora cientifica','Estuve en la azotea estudiando, luego comenzo a llover y tuve que guardar mis cosas rapido, sin embargo no pude guardar mi calculadora','comedor central','azotea',NULL,1,2,2,4),(6,'Mi amigo se desmayo ','El cubiculo fue muy pequenio y mi amigo no pudo soportarlo','biblioteca central','cubiculo 108',NULL,2,5,3,4),(7,'Sono un ruido extraño','Para poder cargar mi laptop conecte su cargador y de pronto salieron chispas y se escucho un sonido extraño','pabellon V','laboratorio 306',NULL,1,6,3,2),(8,'No encontre mi laptop','Tenia muchas ganas de ir al banio, por eso la deje por menos de cinco minutos, luego volvi y no estaba','mac gregor','banio',NULL,4,2,2,2),(9,'Me robaron mi cartuchera','Un chico estuvo cerca mio en la biblioteca, luego de un rato desaparecio y me di cuenta que no estaba mi cartuchera','biblioteca sociales','sotano 1',NULL,8,1,2,2),(10,'Se me cayo un collar','Cuando estaba guardando mis cosas,  luego de terminar mi rutina, no encontre mi collar','polideportivo','cancha',NULL,4,2,1,2);
...
INSERT INTO `rol` VALUES (1,'seguridad'),(2,'usuario pucp'),(3,'Administrador');
...
-- Dump completed on 2022-11-30 14:59:52
